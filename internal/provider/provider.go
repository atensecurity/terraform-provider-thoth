...
func (p *thothProvider) Resources(_ context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		...
		resources.NewPolicyBundleResource,
		resources.NewPolicyExceptionResource,
		resources.NewPolicyExceptionReviewResource,
		resources.NewPolicyChangeArtifactApplyResource,
...
func (p *thothProvider) DataSources(_ context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		...
		data_sources.NewSessionForensicsDataSource,
		data_sources.NewIncidentForensicsDataSource,
		data_sources.NewAgentLatestForensicsDataSource,
		...
		data_sources.NewGovernancePackRulesDataSource,
		data_sources.NewGovernancePackRuleVersionsDataSource,
		...
		data_sources.NewPolicyExceptionDataSource,
		data_sources.NewPolicyExceptionsDataSource,
		data_sources.NewPolicyChangeArtifactDataSource,
		data_sources.NewPolicyChangeArtifactsDataSource,
